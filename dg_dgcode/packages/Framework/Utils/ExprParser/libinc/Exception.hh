...
namespace ExprParser {
  ...
  public:
#ifdef NEED_CXX11_WORKAROUNDS
    ParseError(const char * msg) : std::runtime_error(msg), InputError() {}
#else
  ...
  public:
#ifdef NEED_CXX11_WORKAROUNDS
    DomainError(const char * msg) : std::domain_error(msg), InputError() {}
#else
  ...
  public:
#ifdef NEED_CXX11_WORKAROUNDS
    LogicError(const char * msg) : std::logic_error(msg), Exception() {}
#else
